...
Route::group(['prefix' => '/admin'], function(){
    ...
    Route::group(['prefix' => '/attendance'], function(){
        ...
        /// search record
        ///me
        Route::get('/Renge/{id}', [AttendanceController::class, 'attendence_range'])->middleware(['auth', 'verified'])->name('renge.button');

        Route::get('/midButton/{id}', [AttendanceController::class, 'search_attendance'])->middleware(['auth', 'verified'])->name('mid.button');
        Route::get('/finalButton/{id}', [AttendanceController::class, 'search_attendance'])->middleware(['auth', 'verified'])->name('final.button');
