...
class AttendanceController extends Controller
{
    ...
    public function search_attendance($id){
        ...
        // return view('backend.pages.setup.attendance.attendence_range', compact('course', 'student'));


    }
    public function attendence_range($id){
      //  return view('backend.pages.setup.attendance.attendence_range', compact('course', 'student'));
        return view('backend.pages.setup.attendance.attendence_range')->with('id',$id);
